...
Verify(const CScript& scriptSig, const CScript& scriptPubKey, bool fStrict, ScriptError& err)
{
    ...
    txTo.vin[0].prevout.hash = txFrom.GetHash2();
...
BOOST_AUTO_TEST_CASE(sign)
{
    ...
    for (int i = 0; i < 8; i++)
    {
        ...
        txTo[i].vin[0].prevout.hash = txFrom.GetHash2();
...
BOOST_AUTO_TEST_CASE(AreInputsStandard)
{
    ...
    coins.ModifyCoins(txFrom.GetHash2())->FromTx(txFrom, 0);
    ...
    for (int i = 0; i < 5; i++)
    {
        ...
        txTo.vin[i].prevout.hash = txFrom.GetHash2();
    }
    ...
    txToNonStd1.vin[0].prevout.hash = txFrom.GetHash2();
    ...
    txToNonStd2.vin[0].prevout.hash = txFrom.GetHash2();

...
SetupDummyInputs(CBasicKeyStore& keystoreRet, CCoinsViewCache& coinsRet)
{
    ...
    coinsRet.ModifyCoins(dummyTransactions[0].GetHash2())->FromTx(dummyTransactions[0], 0);
    ...
    coinsRet.ModifyCoins(dummyTransactions[1].GetHash2())->FromTx(dummyTransactions[1], 0);
...
BOOST_AUTO_TEST_CASE(test_Get)
{
    ...
    t1.vin.resize(3);
    t1.vin[0].prevout.hash = dummyTransactions[0].GetHash2();
    t1.vin[0].prevout.n = 1;
    t1.vin[0].scriptSig << std::vector<unsigned char>(65, 0);
    t1.vin[1].prevout.hash = dummyTransactions[1].GetHash2();
    t1.vin[1].prevout.n = 0;
    t1.vin[1].scriptSig << std::vector<unsigned char>(65, 0) << std::vector<unsigned char>(33, 4);
    t1.vin[2].prevout.hash = dummyTransactions[1].GetHash2();
...
BOOST_AUTO_TEST_CASE(test_IsStandard)
{
    ...
    t.vin.resize(1);
    t.vin[0].prevout.hash = dummyTransactions[0].GetHash2();
    t.vin[0].prevout.n = 1;
